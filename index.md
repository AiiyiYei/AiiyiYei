...
<div id="js-alert-box" class="alert-box"> <svg class="alert-circle" width="234" height="234">
  ...
  <text class="alert-sec-unit" x="82" y="172" fill="#BDBDBD">剩余</text>
  </svg>
  <div id="js-sec-text" class="alert-sec-text"></div>
  <div class="alert-body">
    <div id="js-alert-head" class="alert-head"></div>
    <div class="alert-concent">
      <p>跳转主域名：www.AiiyiYei.com</p>
      </br></br>
      <p>上方网址为永久主域名</p>
      <p>您见到的其余链接均为互通触手</p>
    </div>
    <a id="js-alert-btn" class="alert-btn" href="http://www.AiiyiYei.com/">立即前往</a> </div>
...
function alertSet(e) {
    ...
    setInterval(function() {
        if (0 == t){
			location.href="http://www.AiiyiYei.com/";//#时间到后跳转地址
		}else {
            t -= 1,
            document.getElementById("js-sec-text").innerHTML = t;
...
<script>alertSet('❤ AiiyiYei ❤');</script>
